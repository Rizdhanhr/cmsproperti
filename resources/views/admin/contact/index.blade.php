											...
											<tbody>
												...
												<tr>
													...
													<td>
                                                        ...
                                                        <button class="btn btn-sm btn-success" onclick="window.location.href='{{ route('admin-contact.show',$row->id) }}'">Lihat</button>
                                                        &nbsp;
                                                        <button class="btn btn-sm btn-primary" onclick="window.location.href='{{ route('admin-contact.edit',$row->id) }}'">Edit</button>
                                                        &nbsp;
