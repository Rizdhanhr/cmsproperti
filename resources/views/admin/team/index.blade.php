							...
							<div class="card">
								<div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
										...
										<button class="btn btn-primary btn-round ml-auto" onclick="window.location.href='{{route('admin-team.create')}}'">
											...
											<tbody>
												...
												<tr>
													...
													<td>
                                                        ...
                                                        <button class="btn btn-sm btn-success" onclick="window.location.href='{{route('admin-team.show',$row->id)}}'">Lihat</button>
                                                        &nbsp;
                                                        <button class="btn btn-sm btn-primary" onclick="window.location.href='{{route('admin-team.edit',$row->id)}}'">Edit</button>
                                                        &nbsp;
