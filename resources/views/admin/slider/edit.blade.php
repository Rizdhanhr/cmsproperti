							...
							<div class="card">
								...
								<div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span style="color: red">@error('deskripsi')
                                            {{ $message }}
                                        @enderror</span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span style="color: red">@error('alamat') {{ $message }}
                                            
                                        @enderror</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="Nama Kategori">Harga</label>
                                        <input type="text" class="form-control @error('harga') is-invalid @enderror" value="{{ $row->harga }}" name="harga">
                                        <span style="color: red">@error('harga')
                                            {{ $message }}
                                        @enderror</span>
                                    </div>
                                    <div class="form-group">
