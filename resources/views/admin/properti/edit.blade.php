...
<head>
	...
	<title>Notifications - Atlantis Lite Bootstrap 4 Admin Dashboard</title>
								...
								<div class="card-body">
									<table class="table table-bordered">
										...
										<tr>
											...
											<td>
												<button type="button" class="btn btn-focus" id="alert_demo_2"> Show me</button>		
											</td>
										</tr>
										<tr>
											<td style="width: 40%; vertical-align: middle;">Enable <code>warning</code>, <code>error</code>, <code>success</code>, and <code>info</code> state icons</td>
											<td>
												<button type="button" class="btn btn-warning" id="alert_demo_3_1"> Warning</button>		
										...
										<tr>
											<td style="width: 40%; vertical-align: middle;">Modal window with input field</td>
											<td>
