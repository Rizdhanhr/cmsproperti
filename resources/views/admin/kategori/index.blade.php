							...
							<div class="card">
								<div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
										...
										<button class="btn btn-primary btn-round ml-auto" onclick="window.location.href='{{route('admin-kategori.create')}}'">
											...
											<tbody>
												...
												<tr>
													...
													<td>
                                                        ...
                                                        <button class="btn btn-sm btn-primary" onclick="window.location.href='{{route('admin-kategori.edit',$row->id)}}'">Edit</button>
                                                        &nbsp;
